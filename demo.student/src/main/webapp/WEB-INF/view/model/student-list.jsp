...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${ctxStatic}lib/My97DatePicker/4.8/WdatePicker.js"></script> 
